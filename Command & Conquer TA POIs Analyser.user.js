			...
			qx.Class.define('ccta_pa',
			{
				...
				construct: function()
				{
					...
					//Simulator
						...
						rankingTableColumnModel.setColumnWidth(0, 50);
						rankingTableColumnModel.setColumnWidth(1, 120);
						rankingTableColumnModel.setColumnWidth(2, 100);
						rankingTableColumnModel.setColumnWidth(3, 70);
						rankingTableColumnModel.setColumnWidth(4, 100);
						...
						resultsTableColumnModel.setColumnWidth(0, 100);
						resultsTableColumnModel.setColumnWidth(1, 100);
						resultsTable.set({
							columnVisibilityButtonVisible: false,
							headerCellHeight: 25,
							marginTop: 5,
						...
						poisTableColumnModel.setColumnWidth(0, 70);
						poisTableColumnModel.setColumnWidth(1, 50);
						poisTableColumnModel.setColumnWidth(2, 100);
						poisTableColumnModel.setColumnWidth(3, 60);
